...
import 'package:padelgo/ui/home/equipment/equipment_view.dart' as padelgo;
import 'package:padelgo/ui/home/cafe/cafe_menu_view.dart' as padelgo;
import 'package:stacked/stacked.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:padelgo/ui/scaffold_view_model.dart';
...
class ScaffoldView extends StatefulWidget {
  ...
  const ScaffoldView({super.key, required this.child});

  static MaterialPage page(Widget child) =>
      MaterialPage(child: ScaffoldView(child: child));
...
class _ScaffoldViewState extends State<ScaffoldView>
  ...
  Widget _buildNavItem(ScaffoldViewModel vm, int index, bool isSelected,
    ...
    return InkWell(
      onTap: () => vm.onNavigationItemClicked(context, index),
      child: Container(
        width: 70,
                ...
                _buildSheetOption(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const padelgo.EquipmentView(),
                      ),
                    );
                  },
                ),
                _buildSheetOption(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const padelgo.CafeMenuView(),
                      ),
                    );
                  },
                ),
