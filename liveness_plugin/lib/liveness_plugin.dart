...
// Export the utility class for easy access
export 'liveness_util.dart';
...
class LivenessPlugin {
  ...
  static void setVideoConfig(bool recordSwitch, int maxRecordSeconds) {
    _channel.invokeMethod("setVideoConfig",
        {"recordSwitch": recordSwitch, "maxRecordSeconds": maxRecordSeconds});
  }

  static void setAuditConfig(bool collectSwitch, int imageQuality,
      int imageWidth, int imageMaxNumber, int imageCaptureInterval) {
    _channel.invokeMethod("setAuditConfig", {
  ...
  static void setSignatureId(String signatureId) {
    _channel.invokeMethod("setSignatureId", {"signatureId": signatureId});
  }
